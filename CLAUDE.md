...
- **`docs/`** — planning + source of truth. Start here.
  ...
  - `ARCHITECTURE.md` — system design, data model, roadmap, and open questions for the team (§11).
...
- New questions for the team go in `docs/ARCHITECTURE.md` §11, not a new file.
